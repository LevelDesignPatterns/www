let patterns = [
  {
    ...
    "motivation": "In adversarial team games designers can more easily make the game balanced by making the space balanced. This may lead to predicatable level shapes, we can create a better experience and improve orientation by making each half different to the other.",
    "principles": [
      "Spatial"
    ],
    "scale": [ "Large" ],
...

  {
    ...
    "description": "A dual sided terraced canyon",
    "examples": "",
    "motivation": "",
    "aliases": "",
    "principles": [ "Topological, Spatial" ],
